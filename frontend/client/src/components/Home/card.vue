<template>
  ...
  <!-- <div class="bg-white rounded-lg shadow-lg overflow-hidden">
    <div class="px-6 py-4">
      <div class="font-bold text-xl mb-2">{{ name }} ({{ symbol }})</div>
  ...
  <div class="bg-white rounded-3xl border shadow-xl p-8 w-1/6">
    ...
    <div>
      <h3 class="font-semibold text-sm text-gray-400">{{ symbol }}</h3>
      <h1 class="font-semibold text-xl text-gray-700">${{ price }}</h1>
    </div>
  <!-- </div> -->
</div>
</template>
