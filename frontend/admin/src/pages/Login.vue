<template>
  <div class="py-5 flex justify-center items-center h-screen px-6 bg-[#121D33]">
    <div class="">
      <div
        class="text-white flex justify-center items-center py-4 text-xl font-bold"
      >
        Santim Crypto
      </div>
        ...
        <div class="p-6 sm:w-[500px] w-full bg-[#FFFFFF] rounded-md shadow-md">
          <div class="flex items-center justify-center">
            <span class="text-sm font-bold text-gray-700"
              >Well Come To Santim Crypto Admin</span
            >
          </div>
          <Form
          ...
          >
            ...
            <div class="pt-2">
              ...
              <div>
                ...
                <router-link class="text-blue-400" to="/forget-password"
...
const onSubmit = async () => {
  ...
  try {
    ...
    localStorage.setItem("cryptoAdminToken", response.data.login.access_token);
    router.push("/");
  } catch (error) {
    console.log(error);
    notify({
