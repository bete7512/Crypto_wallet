<template>
  <div
    class="fixed overlay top-0 left-0 right-0 bottom-0 flex z-10 p-3 overflow-y-auto mx-2"
  >
    <div class="m-auto sm:w-1/2 lg:w-1/3 w-full">
      ...
      >
        ...
        <div class="bg-white px-4 space-y-3 pt-5 pb-4 sm:p-6 sm:pb-4">
          <div class="space-y-2">
            <label class="block text-lg text-black"> Accessory Name </label>
            <select
          ...
          <div class="space-y-2">
            <label class="block text-lg text-black"> Quantity Needed </label>
            <input
              v-model="quantity"
              type="number"
              min="1"
          ...
          <div class="space-y-2">
            <label class="block text-lg text-black"> Reason Needed </label>
            <textarea
              v-model="reason"
