<template>
  ...
  ></Mdrawer>
  <div class="space-x-0 w-full z-30 bg-slate-200 flex justify-between">
    <div class="lg:block z-20 fixed w-1/5 hidden">
      <Drawer class="bg-"></Drawer>
    </div>
    <div class="ml-10 flex-1 bg-slate-200">
      ...
      <div class="w-full right-0 z-10 fixed h-20 bg-white border-black">
        ...
        >
          <div class="mx-3 " data-tippy-content="Menu" data-tippy-placement="right">
            <button @click="nav()" v-if="!isNav"   class="lg:hidden block p-2 hover:ring-red-400 w-40 h-40">
              <svg
          ...
          <div class="flex items-center space-x-7">
            ...
            <div class="relative z-50">
              <button
                ...
                class="relative z-10  flex justify-center items-center  w-12 h-12 overflow-hidden rounded-full  focus:outline-offset-1 focus:ring-gray-600 focus:ring-4   focus:outline-none"
              ...
              >
                <div
                  v-show="show_notification"
                  class="absolute right-0 z-20 w-80 py-2 mt-2 bg-white rounded-md shadow-xl"
                >
                  <a
                    href="#"
                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-[#EF4104] hover:text-white"
                    >Ayele Added his Service requests</a
                  >
                  <a
                    href="#"
                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-[#EF4104] hover:text-white"
                  ...
                  >
                  Ayele Added his Service requests
                  </button>
...
import Mdrawer from "../Mobile/MobileDrawer.vue";
